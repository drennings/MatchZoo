...
if __name__ == '__main__':
    ...
    preprocessor = Preprocess(word_seg_config = { 'enable': True, 'lang': 'en' }, doc_filter_config = { 'enable': False }, word_stem_config = { 'enable': True }, word_lower_config = { 'enable': False }, word_filter_config={'min_freq': 1}, word_index_config = { 'word_dict': None })
