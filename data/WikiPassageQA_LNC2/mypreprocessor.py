...
Output WikiPassageQA_LNC2-train-filtered.txt, WikiPassageQA_LNC2-dev-filtered.txt, WikiPassageQA_LNC2-test-filtered.txt
"""
...
if __name__ == '__main__':
    ...
    outfile = [basedir + 'WikiPassageQA_LNC2-train-filtered.txt', basedir + 'WikiPassageQA_LNC2-dev-filtered.txt', basedir + 'WikiPassageQA_LNC2-test-filtered.txt']
